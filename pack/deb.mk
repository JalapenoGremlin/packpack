...
DPKG_CHANGES:=$(PRODUCT)_$(DEB_VERSION)-$(RELEASE)~0$(ABBREV)_$(DPKG_ARCH).changes
DPKG_BUILD:=$(PRODUCT)_$(DEB_VERSION)-$(RELEASE)~0$(ABBREV)_$(DPKG_ARCH).build
DPKG_DSC:=$(PRODUCT)_$(DEB_VERSION)-$(RELEASE)~0$(ABBREV).dsc
DPKG_ORIG_TARBALL:=$(PRODUCT)_$(DEB_VERSION).orig.tar.$(TARBALL_COMPRESSOR)
DPKG_DEBIAN_TARBALL:=$(PRODUCT)_$(DEB_VERSION)-$(RELEASE)~0$(ABBREV).debian.tar.$(TARBALL_COMPRESSOR)
